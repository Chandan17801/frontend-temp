      ...
      <div className="flex main gap-10 mt-10">
        ...
        >
          ...
          >
              ...
              <div>
                ...
                >
                  <g clipPath="url(#clip0_1_5)">
                    <path
                      d="M28.5591 27.4511L20.071 19.1012L28.5591 10.7512L25.9459 8.18622L14.8262 19.1012L25.9459 30.0161L28.5591 27.4511Z"
                      fill="black"
                    />
                  </g>
                  <defs>
            ...
            <div className="text-[-#000] flex items-center space-x-2 ml-3 gap-5">
              ...
              >
                <g clipPath="url(#clip0_1_10)">
                  <path
                    d="M24.4942 15.5542L26.0926 17.1233L10.3513 32.5747H8.75286V31.0057L24.4942 15.5542ZM30.749 5.28735C30.3146 5.28735 29.8629 5.4579 29.5328 5.78194L26.3532 8.90293L32.8687 15.2984L36.0482 12.1774C36.7258 11.5123 36.7258 10.4378 36.0482 9.77272L31.9826 5.78194C31.6351 5.44084 31.2007 5.28735 30.749 5.28735ZM24.4942 10.7278L5.27795 29.5902V35.9857H11.7934L31.0096 17.1233L24.4942 10.7278Z"
                    fill="#1C1C1C"
                  />
                </g>
                <defs>
                  <clipPath id="clip0_1_10">
                    <rect
                      ...
                      height="40.9311"
                      fill="white"
                      transform="translate(0.0656128 0.170975)"
                    />
                  </clipPath>
                </defs>
              </svg>
            ...
            <div
              className="text-[-#000] flex items-center space-x-2 gap-5"
              style={{
                color: "#858585",
                fontFamily: "Roboto",
                fontSize: "24px",
        ...
        <div className="right w-50 ml-20" style={{ height: "auto" }}>
          ...
          <div className="flex" style={{ marginLeft: "12px" }}>
            <div style={{ margin: "-20px 12px 0px 0px", color: "#858585" }}>
              Keep yourself updated with our latest collections by getting
              notified
            </div>
          ...
          <div className="flex" style={{ marginLeft: "14px" }}>
            ...
            <IoHelpSharp
              style={{ width: "30px", height: "30px", marginLeft: "-160px" }}
            />
          </div>
          <div
            className="flex"
            style={{ margin: "-20px 12px 0px 14px", color: "#858585" }}
          >
            <div>In case of any inconvenience contact us on : email id</div>
          </div>
        </div>
      </div>
    </div>
