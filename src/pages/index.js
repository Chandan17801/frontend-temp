...
export default function Home() {
  ...
  return (
    <div>
        ...
        <div>
          ...
          <div className="flex justify-center  ">
            <div className="flex mt-4 w-[900px] justify-center  gap-5">
              {/* Div 1 */}
              <div
                className="flex flex-col justify-center p-4 h-[400px] w-[300px]"
      ...
      <div className=" w-[100%] m-auto relative" style={{ marginTop: '-150px' }}>
        {/* Yellow Circles */}
        <div
      ...
      <div className="w-[92%] h-[450px] flex justify-center gap-20 items-center bg-yellow-600" style={{ marginTop: "250px", marginLeft: "4%", marginRight: "4%", backgroundImage: "url('vector')" }}>
