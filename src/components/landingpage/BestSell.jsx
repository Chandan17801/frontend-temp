  ...
  return (
    <div>
      ...
      <div style={{ marginTop: "200px" }}>
        <div
          className="w-[92%] h-[580px] m-auto  flex justify-center gap-20 items-center  z-[-10]"
          style={{ backgroundColor: "rgba(194, 174, 0, 1)" }}
        >
          {/* Left Side */}
          <div className="flex flex-col items-center">
            ...
            <div
              ...
              style={{
                backgroundColor: "rgba(236, 220, 75, 0.63)",
                marginTop: "40px",
                marginLeft: "-400px",
              }}
            ></div>
            ...
            <div className="mt-[-150px] ml-60px">
              ...
              >
                ...
                <p className="text-gray-600" style={{ color: "white" }}>
                  Your paragraph text goes here.<br></br> You can add more
                  content as needed.
                </p>
              </div>
            </div>
            ...
            {/* Button */}
            <button
              className="text-black ml-[-134px] mt-20 font-bold py-2 px-4 rounded shadow-md  hover:bg-yellow-600 transition-colors "
              style={{ backgroundColor: "white", border: "black solid 2px" }}
            >
              See More
            </button>
          </div>
